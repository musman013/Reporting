...
import com.nfinity.reporting.reportingapp1.security.JWTAuthenticationFilter;
import com.nfinity.reporting.reportingapp1.security.JWTAuthorizationFilter;

import static com.nfinity.reporting.reportingapp1.security.SecurityConstants.CONFIRM;
import static com.nfinity.reporting.reportingapp1.security.SecurityConstants.REGISTER;
      ...
      /*   if (env.getProperty("fastCode.auth.method").equalsIgnoreCase("oidc") ) {
        ...
        // The following authorization configuration is for database/LDAP
            ...
            http
                    ...
                    .authorizeRequests()
                    .antMatchers("/viewResource/**","/v2/api-docs", "/actuator/**", "/configuration/ui", "/swagger-resources", "/configuration/security", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/webjars/**", "/swagger-resources/configuration/ui", "/swagger-resources/configuration/security", "/browser/index.html#", "/browser/**").permitAll()
                    .antMatchers(HttpMethod.POST, REGISTER).permitAll()
                    .antMatchers(HttpMethod.POST, CONFIRM).permitAll()
                    .anyRequest().authenticated()
                    .and()
