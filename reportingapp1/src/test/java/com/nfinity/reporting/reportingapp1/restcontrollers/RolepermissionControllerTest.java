...
import com.nfinity.reporting.reportingapp1.application.authorization.rolepermission.dto.CreateRolepermissionInput;
import com.nfinity.reporting.reportingapp1.application.authorization.rolepermission.dto.FindRolepermissionByIdOutput;
import com.nfinity.reporting.reportingapp1.application.authorization.rolepermission.dto.UpdateRolepermissionInput;
...
import com.nfinity.reporting.reportingapp1.domain.irepository.IRolepermissionRepository;
...
public class RolepermissionControllerTest {
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table reporting.rolepermission").executeUpdate();
