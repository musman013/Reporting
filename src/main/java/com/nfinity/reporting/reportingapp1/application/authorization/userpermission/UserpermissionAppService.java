package com.nfinity.reporting.reportingapp1.application.authorization.userpermission;

import com.nfinity.reporting.reportingapp1.application.authorization.userpermission.dto.*;
import com.nfinity.reporting.reportingapp1.domain.authorization.userpermission.IUserpermissionManager;
import com.nfinity.reporting.reportingapp1.domain.model.QUserpermissionEntity;
...
public class UserpermissionAppService implements IUserpermissionAppService {
	...
	public BooleanBuilder searchKeyValuePair(QUserpermissionEntity userpermission, Map<String,SearchFields> map,Map<String,String> joinColumns) {
		...
		if(joinCol != null && joinCol.getKey().equals("id")) {
