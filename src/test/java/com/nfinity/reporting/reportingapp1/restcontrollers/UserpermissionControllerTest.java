...
import com.nfinity.reporting.reportingapp1.application.authorization.userpermission.dto.CreateUserpermissionInput;
import com.nfinity.reporting.reportingapp1.application.authorization.userpermission.dto.FindUserpermissionByIdOutput;
import com.nfinity.reporting.reportingapp1.application.authorization.userpermission.dto.UpdateUserpermissionInput;
...
import com.nfinity.reporting.reportingapp1.domain.irepository.IUserpermissionRepository;
...
public class UserpermissionControllerTest {
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table reporting.userpermission").executeUpdate();
