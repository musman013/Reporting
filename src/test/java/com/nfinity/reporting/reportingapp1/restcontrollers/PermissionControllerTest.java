...
import com.nfinity.reporting.reportingapp1.application.authorization.permission.PermissionAppService;
import com.nfinity.reporting.reportingapp1.application.authorization.permission.dto.CreatePermissionInput;
import com.nfinity.reporting.reportingapp1.application.authorization.permission.dto.FindPermissionByIdOutput;
import com.nfinity.reporting.reportingapp1.application.authorization.permission.dto.FindPermissionByNameOutput;
import com.nfinity.reporting.reportingapp1.application.authorization.permission.dto.UpdatePermissionInput;
import com.nfinity.reporting.reportingapp1.application.authorization.rolepermission.RolepermissionAppService;
import com.nfinity.reporting.reportingapp1.application.authorization.userpermission.UserpermissionAppService;
import com.nfinity.reporting.reportingapp1.domain.irepository.IPermissionRepository;
...
public class PermissionControllerTest {
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table reporting.permission").executeUpdate();
